import {
  ...
  STRUCTOGRAM_SWITCH_CONDITION_LINE_CLEARANCE_PX,
  STRUCTOGRAM_SWITCH_CONDITION_SIDE_CLEARANCE_PX,
...
const fitSwitchGeometry = (
  ...
  const conditionBottomY =
    ...
    STRUCTOGRAM_FONT_SIZE +
    STRUCTOGRAM_SWITCH_CONDITION_LINE_CLEARANCE_PX;
  const requiredSideRun = conditionHalfWidth + STRUCTOGRAM_SWITCH_CONDITION_SIDE_CLEARANCE_PX;
