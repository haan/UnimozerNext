...
export const STRUCTOGRAM_MIN_VIEW_SCALE = 0.4; // Lower zoom clamp to keep content usable.
export const STRUCTOGRAM_MAX_VIEW_SCALE = 2.5; // Upper zoom clamp to avoid excessive magnification.
export const STRUCTOGRAM_ZOOM_STEP_IN = 1.1; // Incremental zoom-in factor.
export const STRUCTOGRAM_ZOOM_STEP_OUT = 0.9; // Incremental zoom-out factor.
