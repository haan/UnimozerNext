import {
  ...
  STRUCTOGRAM_IF_CONDITION_LINE_CLEARANCE,
  STRUCTOGRAM_IF_CONDITION_SIDE_CLEARANCE,
...
const fitIfGeometry = (
  ...
  const conditionBottomY =
    ...
    STRUCTOGRAM_FONT_SIZE +
    STRUCTOGRAM_IF_CONDITION_LINE_CLEARANCE;
  const requiredSideWidth = conditionHalfWidth + STRUCTOGRAM_IF_CONDITION_SIDE_CLEARANCE;
